...
file_third_step_transto_quatary = open('file_third_step_transto_quatary.txt','w')
with open('file_second_step_penta.txt','r') as f:
    for strs in f:
        ...
        for word in strs_list:
            if word == ' ':
                ...
                word_len = word_len + len(word) + 1
                file_third_step_transto_quatary.write(word+ ' ')
        # j = 0
        # while strs_list[j]:
        ...
        #
        for i in range(40 - word_len):
            file_third_step_transto_quatary.write(' ')
        file_third_step_transto_quatary.write('          # ' + strs)