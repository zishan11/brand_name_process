...
file_fourth_step_single = open('file_fourth_step_single.txt','w')
file_fourth_step_double = open('file_fourth_step_double.txt','w')
file_fourth_step_triple = open('file_fourth_step_triple.txt','w')
file_fourth_step_quatary = open('file_fourth_step_quatary.txt','w')
file_fourth_step_penta = open('file_fourth_step_penta.txt','w')

file_third_step_transto_single = open('file_third_step_transto_single.txt','w')
with open('file_second_step_double.txt','r') as f:
    for strs in f:
        ...
        # print len(strs_list) - strs_list.count(' ')
        ...
        for word in strs_list:
            if word == ' ':
                ...
                word_len = word_len + len(word) +1
                file_third_step_transto_single.write(word + ' ')
        # j = 0
        # while strs_list[j]:
        ...
        #
        for i in range(40 - word_len):
            file_third_step_transto_single.write(' ')
        file_third_step_transto_single.write('          # ' + strs)
