list_dict = ['New Zealand','America','USA','China','Japan','Europe','Asia','Korea','Universal','Global',                             #country
             'shanghai','shenzhen','Guangdong','guangzhou','Beijing','City','Taiwan','Shandong','Nanjing','suzhou','Anhui',
             'Hangzhou','Chongqing','Fujian','Chengdu','dongguan',   #city
             ...
             'Network','Enterprise','System','Internet','Industr','Security','Engineer',
             ...
             'the','Advance','Design','transmiss','Cinema','Access','Online']
...
file_third_step_transto_triple = open('file_third_step_transto_triple.txt','w')
with open('file_second_step_quatary.txt','r') as f:
    for strs in f:
        ...
        for word in strs_list:
            if word == ' ':
                ...
                word_len = word_len + len(word) + 1
                file_third_step_transto_triple.write(word+ ' ')

        for i in range(40 - word_len):
            file_third_step_transto_triple.write(' ')
        file_third_step_transto_triple.write('          # ' + strs)